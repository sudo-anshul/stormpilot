...
POLICIES = [
    ...
    {"id": "plausible_depth", "label": "Sensor plausibility control", "description": "Track abrupt sensor offsets from past measured depths, then conservatively correct positive offsets without reallocating basin discharge targets."},
...
PARAMETER_SPECS = {
    ...
    "plausible_depth": {"target_scale": (1.0, 0.5, 1.5), "jump_threshold_m": (0.5, 0.2, 2.0),
                        "correction_fraction": (0.8, 0.0, 1.0)},
    "uncontrolled": {},
}
